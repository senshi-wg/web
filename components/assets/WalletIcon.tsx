...
export const WalletIcon = forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(function SearchIcon(props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="#A1A2AB" viewBox="0 0 24 24" >
